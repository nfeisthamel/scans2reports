...
# Form implementation generated from reading ui file '.\scans2reports-1.1.2w\ui_scans_to_reports.ui'
#
...
class UiScansToReports(object):
    def setupUi(self, ScansToReports):
        ...
        ScansToReports.resize(1415, 892)
...
"")
        ...
        self.grp_selected_scans.setGeometry(QtCore.QRect(10, 370, 1391, 209))
...
"")
        ...
        self.grp_scan_summary.setGeometry(QtCore.QRect(10, 590, 1391, 209))
...
"")
        ...
        self.grp_file_drop.setGeometry(QtCore.QRect(750, 0, 651, 361))
...
"}")
        ...
        self.layoutWidget = QtWidgets.QWidget(self.main_content)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 0, 734, 360))
        self.layoutWidget.setObjectName("layoutWidget")
        self.grid_data_points = QtWidgets.QGridLayout(self.layoutWidget)
        self.grid_data_points.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.grid_data_points.setContentsMargins(0, 0, 0, 0)
        self.grid_data_points.setObjectName("grid_data_points")
        self.grp_data_points = QtWidgets.QGroupBox(self.layoutWidget)
        self.grp_data_points.setMinimumSize(QtCore.QSize(300, 0))
        self.grp_data_points.setMaximumSize(QtCore.QSize(326, 400))
...
"}")
        ...
        self.gridLayout_3.addWidget(self.chk_raw_data, 8, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_acas_unique_vuln, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_test_plan, 13, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_summary, 12, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_hardware, 10, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_software_linux, 10, 2, 1, 1)
        self.txt_reviewed_by = QtWidgets.QLineEdit(self.grp_data_points)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txt_reviewed_by.sizePolicy().hasHeightForWidth())
        self.txt_reviewed_by.setSizePolicy(sizePolicy)
        self.txt_reviewed_by.setMinimumSize(QtCore.QSize(150, 25))
        self.txt_reviewed_by.setMaximumSize(QtCore.QSize(150, 25))
        self.txt_reviewed_by.setObjectName("txt_reviewed_by")
        self.gridLayout_3.addWidget(self.txt_reviewed_by, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_cci, 9, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_operating_systems, 13, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_asset_traceability, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_acas_unique_iavm, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_rar, 7, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_missing_patches, 12, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_software_windows, 11, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_ppsm, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_scap_ckl_issues, 9, 2, 1, 1)
        self.txt_system_name = QtWidgets.QLineEdit(self.grp_data_points)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txt_system_name.sizePolicy().hasHeightForWidth())
        self.txt_system_name.setSizePolicy(sizePolicy)
        self.txt_system_name.setMinimumSize(QtCore.QSize(150, 25))
        self.txt_system_name.setMaximumSize(QtCore.QSize(150, 25))
        self.txt_system_name.setObjectName("txt_system_name")
        self.gridLayout_3.addWidget(self.txt_system_name, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_local_users, 11, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chk_poam, 14, 0, 1, 1)
        ...
        self.txt_apms_id = QtWidgets.QLineEdit(self.grp_data_points)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txt_apms_id.sizePolicy().hasHeightForWidth())
        self.txt_apms_id.setSizePolicy(sizePolicy)
        self.txt_apms_id.setMinimumSize(QtCore.QSize(150, 25))
        self.txt_apms_id.setMaximumSize(QtCore.QSize(150, 25))
        self.txt_apms_id.setObjectName("txt_apms_id")
        self.gridLayout_3.addWidget(self.txt_apms_id, 5, 2, 1, 1)
        self.chk_deviation = QtWidgets.QCheckBox(self.grp_data_points)
        self.chk_deviation.setStyleSheet("background:none;")
        self.chk_deviation.setChecked(False)
        self.chk_deviation.setObjectName("chk_deviation")
        self.gridLayout_3.addWidget(self.chk_deviation, 14, 2, 1, 1)
        self.grid_data_points.addWidget(self.grp_data_points, 0, 1, 1, 1)
        self.grpReports = QtWidgets.QGroupBox(self.layoutWidget)
...
"}")
        ...
        self.cboProcIntensity.setGeometry(QtCore.QRect(130, 160, 261, 22))
        ...
        self.lblProcessorIntensity.setGeometry(QtCore.QRect(10, 160, 121, 21))
...
"")
        ...
        self.lblTestResultsProcessing.setGeometry(QtCore.QRect(10, 130, 121, 21))
        ...
        self.cboTestResultFunc.setGeometry(QtCore.QRect(130, 130, 261, 22))
        ...
        self.txtPredisposingCondition.setGeometry(QtCore.QRect(10, 220, 381, 121))
        self.txtPredisposingCondition.setObjectName("txtPredisposingCondition")
        self.cboMitigationStatements = QtWidgets.QComboBox(self.grpReports)
        self.cboMitigationStatements.setGeometry(QtCore.QRect(130, 190, 261, 22))
        self.cboMitigationStatements.setStyleSheet("")
        self.cboMitigationStatements.setObjectName("cboMitigationStatements")
        self.cboMitigationStatements.addItem("")
        self.cboMitigationStatements.addItem("")
        self.cboMitigationStatements.addItem("")
        self.cboMitigationStatements.addItem("")
        self.lblMitigationStatements = QtWidgets.QLabel(self.grpReports)
        self.lblMitigationStatements.setGeometry(QtCore.QRect(10, 190, 121, 21))
        self.lblMitigationStatements.setStyleSheet("background: none;")
        self.lblMitigationStatements.setObjectName("lblMitigationStatements")
        self.chk_show_host_details = QtWidgets.QCheckBox(self.grpReports)
        self.chk_show_host_details.setGeometry(QtCore.QRect(10, 100, 200, 25))
        self.chk_show_host_details.setMinimumSize(QtCore.QSize(0, 25))
        self.chk_show_host_details.setMaximumSize(QtCore.QSize(16777215, 25))
        self.chk_show_host_details.setStyleSheet("background: none;")
        self.chk_show_host_details.setChecked(False)
        self.chk_show_host_details.setObjectName("chk_show_host_details")
        ...
        self.mnu_main.setGeometry(QtCore.QRect(0, 0, 1415, 21))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"}")
        ...
        self.menuUtil = QtWidgets.QMenu(self.mnu_main)
        ...
        self.actionOpenTools = QtWidgets.QAction(ScansToReports)
        self.actionOpenTools.setObjectName("actionOpenTools")
        self.actionLaunchVendorPortsConverter = QtWidgets.QAction(ScansToReports)
        self.actionLaunchVendorPortsConverter.setObjectName("actionLaunchVendorPortsConverter")
        self.actionEnrich_hwsw = QtWidgets.QAction(ScansToReports)
        self.actionEnrich_hwsw.setObjectName("actionEnrich_hwsw")
        ...
        self.menuUtil.addAction(self.actionOpenTools)
        self.menuUtil.addSeparator()
        self.menuUtil.addAction(self.actionLaunchVendorPortsConverter)
        self.menuUtil.addSeparator()
        self.menuUtil.addAction(self.actionEnrich_hwsw)
        ...
        self.mnu_main.addAction(self.menuUtil.menuAction())
        ...
        ScansToReports.setTabOrder(self.txt_email, self.txt_system_name)
        ScansToReports.setTabOrder(self.txt_system_name, self.txt_reviewed_by)
        ScansToReports.setTabOrder(self.txt_reviewed_by, self.txt_apms_id)
        ScansToReports.setTabOrder(self.txt_apms_id, self.chk_acas_unique_iavm)
        ...
        ScansToReports.setTabOrder(self.btn_execute, self.btnClearSelectedScans)
        ScansToReports.setTabOrder(self.btnClearSelectedScans, self.btnClearScanSummary)
        ScansToReports.setTabOrder(self.btnClearScanSummary, self.chk_raw_data)
        ScansToReports.setTabOrder(self.chk_raw_data, self.chk_test_plan)
        ScansToReports.setTabOrder(self.chk_test_plan, self.chk_summary)
        ScansToReports.setTabOrder(self.chk_summary, self.chk_hardware)
        ScansToReports.setTabOrder(self.chk_hardware, self.chk_software_linux)
        ScansToReports.setTabOrder(self.chk_software_linux, self.chk_cci)
        ScansToReports.setTabOrder(self.chk_cci, self.chk_operating_systems)
        ScansToReports.setTabOrder(self.chk_operating_systems, self.chk_rar)
        ScansToReports.setTabOrder(self.chk_rar, self.chk_missing_patches)
        ScansToReports.setTabOrder(self.chk_missing_patches, self.chk_software_windows)
        ScansToReports.setTabOrder(self.chk_software_windows, self.chk_ppsm)
        ScansToReports.setTabOrder(self.chk_ppsm, self.chk_scap_ckl_issues)
        ScansToReports.setTabOrder(self.chk_scap_ckl_issues, self.chk_local_users)
        ScansToReports.setTabOrder(self.chk_local_users, self.chk_poam)
        ScansToReports.setTabOrder(self.chk_poam, self.cboTestResultFunc)
        ScansToReports.setTabOrder(self.cboTestResultFunc, self.chkIncludeFindingDetails)
        ScansToReports.setTabOrder(self.chkIncludeFindingDetails, self.txtPredisposingCondition)
        ScansToReports.setTabOrder(self.txtPredisposingCondition, self.cboMitigationStatements)
        ScansToReports.setTabOrder(self.cboMitigationStatements, self.chk_show_host_details)
...
"\n"
"    .ckl(b)     - STIG/Checklist Files\n"
"    .nessus     - ACAS Scan Results\n"
"    .xml        - SCAP/XCCDF Files\n"
"\n"
"    .csv        - Mitigation Statement, Impact Statement, and/or Resources Required Answer File\n"
...
"               "))
        ...
        self.txt_reviewed_by.setToolTip(_translate("ScansToReports", "Enter name of report generator"))
        self.txt_reviewed_by.setPlaceholderText(_translate("ScansToReports", "Reviewed By"))
        ...
        self.txt_system_name.setToolTip(_translate("ScansToReports", "Enter the system name"))
        self.txt_system_name.setPlaceholderText(_translate("ScansToReports", "Security System Name"))
        ...
        self.txt_apms_id.setToolTip(_translate("ScansToReports", "Enter APMS ID if known"))
        self.txt_apms_id.setPlaceholderText(_translate("ScansToReports", "APMS ID"))
        self.chk_deviation.setToolTip(_translate("ScansToReports", "This is the deviations document"))
        self.chk_deviation.setText(_translate("ScansToReports", "Deviation"))
...
"If the CCI is linked to a control that is inherited or not in the package, change control to CM-6"))
        ...
        self.cboMitigationStatements.setItemText(0, _translate("ScansToReports", "Leave Blank"))
        self.cboMitigationStatements.setItemText(1, _translate("ScansToReports", "Existing POAM or Answerfile CSV"))
        self.cboMitigationStatements.setItemText(2, _translate("ScansToReports", "CKL Comments"))
        self.cboMitigationStatements.setItemText(3, _translate("ScansToReports", "POAM/CSV, then CKL (Prefer Existing POAM/CSV)"))
        self.lblMitigationStatements.setText(_translate("ScansToReports", "Mitigation Statements"))
        self.chk_show_host_details.setToolTip(_translate("ScansToReports", "If this is checked, affected devices on the POAM and RAR tabs will show up as:\n"
"\n"
"hostname [SCAN_TYPE - Ver: #, Rel/Feed: # ]\n"
"\n"
"If this is not checked, affected devices will only show their hostname"))
        self.chk_show_host_details.setText(_translate("ScansToReports", "Show Host Details"))
        ...
        self.menuUtil.setTitle(_translate("ScansToReports", "Util"))
        ...
        self.actionOpenTools.setText(_translate("ScansToReports", "Open \'Tools\'"))
        self.actionLaunchVendorPortsConverter.setText(_translate("ScansToReports", "Launch Vendor Ports Converter"))
        self.actionEnrich_hwsw.setText(_translate("ScansToReports", "Enrich HW/SW Report"))
